...
// run the game.
        ...
        MyGame = ig.Game.extend({
            ...
            init: function () {
                ...
                this.loadLevel(LevelGrassnever);
            },
            ...
            setupCamera: function () {
                ...
                this.camera.max.x = this.collisionMap.pxWidth - ig.system.width + 9999;
                this.camera.max.y = this.collisionMap.pxHeight - ig.system.height + 9999;
